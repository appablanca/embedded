...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        layoutWidget->setGeometry(QRect(170, 60, 454, 194));
        ...
        widget->setGeometry(QRect(270, 320, 196, 26));
        ...
        testLine = new QLineEdit(widget);
        testLine->setObjectName("testLine");

        horizontalLayout_3->addWidget(testLine);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        pushButton_2->setText(QCoreApplication::translate("MainWindow", "send to udp", nullptr));
    } // retranslateUi
